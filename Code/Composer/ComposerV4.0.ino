/*
~~Composer v4 changelog~~
*Rewrote placeNote() to save placed notes to the appropriate saveBuffer instead of compBuffer
*Added to reloadBuffer()
   >Saves saveBuffer0 & saveBuffer1 to their respective temp files before both buffers are rewritten
