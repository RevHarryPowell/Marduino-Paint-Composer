/*
~~Marduino Paint Composer v1.0~~
*Combines much of what was previously written in separate sketches
*Works through over-arching menu system using the character LCD and rotary encoder C
*Functions inculde:
  >Composer (slightly modified from v5.2)
  >Save

¡STILL TO DO!
**Encorporate playback function (as well as playback/compose switch)
