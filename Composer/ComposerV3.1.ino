/*
~~Composer v3.1 changelog~~
*Re-wrote reloadBuffer()
  >Loads appropriate file completely into saveBuffer0
  >Loads next file into saveBuffer0
  >>dramatically increases scroll speed and responiveness (except when crossing between files)

**placeNote() needs modification to accomidate longer notes
**Newly-placed notes must be saved to corresponding TXT file
